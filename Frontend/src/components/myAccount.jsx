...
class MyAccount extends Component {
  ...
  validate = () => {
    ...
    // } else if (!this.state.mobileNumber.match("^[789][0-9]{9}")) {
    //   MobileNumberError = "Mobile Number must include only numbers";
    }
        ...
        <div className="container mt-2">
          ...
          <form method="POST" onSubmit={this.stopSubmission}> 
            ...
            <div>
              ...
              {/* <Link to="/"> <button onClick={this.logout()}  class="btn btn-primary pull-right">Save</button></Link> */}
              <Link to="/">
